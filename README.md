<div align="center">
    ...
    <p>
        Encurtador de URLs com autenticação, analytics de cliques e cache distribuído.</br>
        Dois serviços independentes: Go cuida dos redirecionamentos, Java cuida do restante.
    </p>
    <p>
        <img src="https://img.shields.io/badge/Go-00ADD8?logo=go" alt="golang" />
        <img src="https://img.shields.io/badge/Java-ED8B00?logo=openjdk" alt="java" />
        <img src="https://img.shields.io/badge/PostgreSQL-4169E1?logo=postgresql&logoColor=white" alt="postgresql" />
        <img src="https://img.shields.io/badge/Redis-DC382D?logo=redis&logoColor=white" alt="redis" />
        <img src="https://img.shields.io/badge/React-61DAFB?logo=react&logoColor=black" alt="react" />
        <img src="https://img.shields.io/badge/Docker-2496ED?logo=docker&logoColor=white" alt="docker" />
    </p>
    <img src="docs/demo-auth.gif" alt="demo auth gif">
</div>
...
```mermaid
graph LR
    Client -->|GET /:slug| Go[Go Redirector :5001]
    Go -->|cache hit| Redis
    Go -->|cache miss| PG[(PostgreSQL)]
    Go -.->|async| PG

    Client -->|REST API| Java[Java API :5000]
    Java --> PG
```
...
| Go Redirector | http://localhost:5001 |
